...
- **Heating assets** designates the systems delivering heating, either as *Space-heating assets* or *Water-heating assets*.
...
- sharing of consumption data throughout the period (with dedicated sub-metering of the power delivered to the *heating assets*, either individually or aggregated),
